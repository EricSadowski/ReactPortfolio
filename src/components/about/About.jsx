...
const About = () => {
    return (
        ...
        <p className="a-desc">
        Eric Sadowski is a Web Developer and Multi-Media Artist from Montréal, Québec. Born in Vancouver, British Columbia, he has a strong background in HTML/CSS, Photoshop, Javascript, C#, ASP.NET, React, SpringBoot, Node.js, Java, PHP, and MySQL. With a passion for technology and art, Eric brings a unique blend of creativity and technical expertise to his work.
        </p>
           </div>
        </div>
    )
